...
Revision ID: b5c61c2e7da7
Revises: 
Create Date: 2026-01-01 21:32:07.111938
...
def upgrade() -> None:
    ...
    sa.Column('transaction_type', sa.Enum('IN', 'OUT', 'REVERSAL', name='inventory_transaction_type'), nullable=False),
    sa.Column('quantity', sa.Integer(), nullable=False),
